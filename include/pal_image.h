...
/*2d gauss filter (3x3) */
void p_gauss3x3_32f(const float* x, float* r, int rows, int cols);
...
void p_sad8x8_32f(const float* x, float* r, int rows, int cols);
void p_sad16x16_32f(const float* x, float* r, int rows, int cols);

/*2d sum of mean differences*/
void p_mad8x8_32f(const float* x, float* r, int rows, int cols);
void p_mad16x16_32f(const float* x, float* r, int rows, int cols);
