...
int load_float_data(char *filename, int lines, float *a, float *b, float *c,
                    float *g);
void dump_results(char *filename, float *ai, float *bi, float *ci, float *res,
                  int lines);
